...
<body style="background-size: 100% 100% ">
	...
	<?php 
		...
		$data=mysqli_query($link,"select * from trains where Train_name='GUJRAT MAIL' ")or die(mysqli_error());
			...
			if($not<=4)
			{
				...
				//print"<tr><p><td>Date</td><td><input name='date$in' type='date' class='text' style='border-radius: 15px; width:90%; height:150%;padding-bottom:10px'required></td></p></tr>";
